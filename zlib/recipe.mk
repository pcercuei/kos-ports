...
#zlib_DOWNLOAD_URL =      http://zlib.net/zlib-${zlib_PORTVERSION}.tar.gz
zlib_DOWNLOAD_URL =      https://github.com/madler/zlib/releases/download/v${zlib_PORTVERSION}/zlib-${zlib_PORTVERSION}.tar.gz
