...
SDL_ttf_DOWNLOAD_SITE =     https://github.com/libsdl-org/SDL_ttf/archive/
SDL_ttf_DOWNLOAD_FILE =     ${SDL_ttf_GIT_HASH}.tar.gz

SDL_ttf_CONFIGURE_ARGS =    SDL_CFLAGS="-I${KOS_PORTS}/sysroot/include/SDL" SDL_LIBS="-lSDL"
